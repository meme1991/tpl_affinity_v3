...
<?php if ($this->contact->address && $this->params->get('show_street_address')) : ?>
	<div class="field" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
		<h4 class="fw-600"><i class="fas fa-map-marker-alt"></i> <?php echo JText::_('TPL_AFFINITY_CONTACTPAGE_ADDRESS'); ?></h4>
...
<?php if ($this->contact->telephone && $this->params->get('show_telephone')) : ?>
	<div class="field">
		<h4 class="fw-600" itemprop="telephone" content="<?php echo $this->contact->telephone; ?>"><i class="fas fa-phone-square"></i><?php echo JText::_('TPL_AFFINITY_CONTACTPAGE_TELEFONO'); ?></h4>
...
<?php if ($this->contact->mobile && $this->params->get('show_mobile')) : ?>
	<div class="field">
		<h4 class="fw-600"><i class="fas fa-mobile"></i> <?php echo JText::_('TPL_AFFINITY_CONTACTPAGE_MOBILE'); ?></h4>
...
<?php if ($this->contact->fax && $this->params->get('show_fax')) : ?>
	<div class="field">
		<h4 class="fw-600"><i class="fas fa-fax"></i> <?php echo JText::_('TPL_AFFINITY_CONTACTPAGE_FAX'); ?></h4>
...
<?php if ($this->contact->webpage && $this->params->get('show_webpage')) : ?>
	<div class="field">
		<h4 class="fw-600" itemprop="url" content="<?php echo JStringPunycode::urlToUTF8($this->contact->webpage) ?>"><i class="fas fa-globe"></i> <?php echo JText::_('TPL_AFFINITY_CONTACTPAGE_WEBSITE'); ?></h4>
