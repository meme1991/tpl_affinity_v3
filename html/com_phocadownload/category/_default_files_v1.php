		...
		foreach ($this->files as $v) :
			...
			if ($rightDisplay == 1) :
				...
				if ($v->filename != '') {
					...
					$ext = substr($v->filename, strrpos($v->filename, '.')+1, strlen($v->filename));
					switch ($ext) {
						...
						case 'gif':
						case 'jpg':
						case 'jpeg': $icon = 'fa-file-image-o'; break;
				  ...
				  <li class="list-group-item flex-column align-items-start">
						<div class="w-100">
							<div class="button-box">
								<button class="btn btn-secondary" type="button" data-toggle="collapse" data-target="#collapseDetailsFile<?php echo $v->id ?>" aria-expanded="false" aria-controls="collapseDetailsFile<?php echo $v->id ?>"></button>
				      ...
				      <h5 class="mb-1">
						...
						<?php if ($fileSize != '') : ?>
						<tr>
							<th scope="row"><?php echo JText::_('Grandezza file') ?></th>
							<td><?php echo $fileSize ?></td>
						</tr>
						<?php endif; ?> -->


						<!-- <p><?php echo $linkDownloadB .$l->getName($v->title, $v->filename) .$linkDownloadE ?></p> -->
						<small class="text-muted"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo JHtml::_('date', $v->publish_up, JText::_('DATE_FORMAT_LC3')) ?></small>
						<?php $imageFileName = $l->getImageFileName($v->image_filename, $v->filename) ?>
						<div class="collapse w-100 mt-2" id="collapseDetailsFile<?php echo $v->id ?>">
						  <div class="card card-block  w-100">
								...
								<table class="table table-sm table-striped w-100">
								  <tbody>
										<?php if ($v->title != '') : ?>
								    <tr>
								      <th scope="row"><?php echo JText::_('Nome file') ?></th>
								    ...
								    <tr>
								      <th scope="row"><?php echo JText::_('Image download') ?></th>
								      <td><?php echo $l->getImageDownload($v->image_download) ?></td>
								    </tr>
										<?php endif; ?>
								    ...
								    <tr>
								      ...
								      <td><?php echo $fileSize ?></td>
										...
										<?php if ($v->version != '') : ?>
								    <tr>
								      <th scope="row"><?php echo JText::_('Versione') ?></th>
								      <td><?php echo $v->version ?></td>
										...
										<?php if ($v->license != '') : ?>
								    <tr>
								      <th scope="row"><?php echo JText::_('Licenza') ?></th>
								    ...
								    <tr>
								      ...
								      <td><?php echo $v->license_url ?></td>
										...
										<?php if ($v->author != '') : ?>
								    <tr>
								      <th scope="row"><?php echo JText::_('Autore') ?></th>
											<?php if($v->author_url != '') : ?>
								      <td><?php echo $v->author_url ?></td>
											<?php else : ?>
								    ...
								    <tr>
								      <th scope="row"><?php echo JText::_('COM_PHOCADOWNLOAD_EMAIL') ?></th>
								      <td><?php echo $l->getProtectEmail($v->author_email) ?></td>
								    </tr>
										<?php endif; ?>
										...
										<?php if ($fileDate != '') : ?>
								    <tr>
								      <th scope="row"><?php echo JText::_('COM_PHOCADOWNLOAD_DATE') ?></th>
								    ...
								    <tr>
								      <th scope="row"><?php echo JText::_('COM_PHOCADOWNLOAD_DOWNLOADS') ?></th>
								      <td><?php echo $v->hits ?></td>
								    </tr>
										<?php endif; ?>

										<?php if ($l->isValueEditor($v->description) && $this->t['display_description'] != 1 & $this->t['display_description'] != 2 & $this->t['display_description'] != 3) : ?>
								    <tr>
								      <th scope="row"><?php echo JText::_('Descrizione') ?></th>
								    ...
								    <tr>
								      <th scope="row"><?php echo JText::_('COM_PHOCADOWNLOAD_FEATURES') ?></th>
								      <td><?php echo $v->features ?></td>
								    </tr>
										<?php endif; ?>

										<?php if ($l->isValueEditor($v->changelog)) : ?>
								    <tr>
								      <th scope="row"><?php echo JText::_('COM_PHOCADOWNLOAD_CHANGELOG') ?></th>
								      <td><?php echo $v->changelog ?></td>
								    </tr>
										<?php endif; ?>

										<?php if ($l->isValueEditor($v->notes)) : ?>
								    <tr>
								      <th scope="row"><?php echo JText::_('COM_PHOCADOWNLOAD_NOTES') ?></th>
