...
?>
<div class="wrapper container com_users profile-edit <?php echo $this->pageclass_sfx; ?>">
	<div class="row">
		<div class="col-12">
			...
			<form id="member-profile" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-validate form-horizontal well" enctype="multipart/form-data">
				...
				<?php foreach ($this->form->getFieldsets() as $group => $fieldset) : ?>
					...
					<?php if (count($fields)) : ?>
						<div class="col-12 col-sm-12 col-md-6 px-md-4">
							<fieldset>
				...
				<div class="col-12 col-sm-12 col-md-6 mt-5">
					<div class="control-group mt-2">
						<div class="controls">
							<button type="submit" class="btn btn-primary btn-block validate"><i class="fas fa-check-circle pr-2"></i> <?php echo JText::_('Conferma'); ?></button>
							<a class="btn btn-secondary btn-block" href="<?php echo JRoute::_('index.php?option=com_users&view=profile'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><i class="far fa-times pr-2"></i> <?php echo JText::_('JCANCEL'); ?></a>
