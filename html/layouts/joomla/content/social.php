...
<?php $link = JURI::base().JRoute::_(ContentHelperRoute::getArticleRoute($displayData['item']->slug, $displayData['item']->catid, $displayData['item']->language)); ?>
  ...
  <li class="list-inline-item" data-toggle="tooltip" data-placement="bottom" title="<?php echo JText::_('TPL_AFFINITY_SHARE_FACEBOOK') ?>">
  ...
  <li class="list-inline-item" data-toggle="tooltip" data-placement="bottom" title="<?php echo JText::_('TPL_AFFINITY_SHARE_TWITTER') ?>">
  ...
  <li class="list-inline-item" data-toggle="tooltip" data-placement="bottom" title="<?php echo JText::_('TPL_AFFINITY_SHARE_GOOGLEPLUS') ?>">
  ...
  <li class="list-inline-item" data-toggle="tooltip" data-placement="bottom" title="<?php echo JText::_('TPL_AFFINITY_SHARE_WHATSAPP') ?>">
