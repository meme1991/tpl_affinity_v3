								...
								<?php if ($this->params->get('show_empty_categories') || $child->numitems || count($child->getChildren())) : ?>
									<div class="list-h d-md-flex justify-content-md-between">
									  <h4 class="card-title d-inline mb-3">
										...
										<div class="">
									    <a href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($child->id)); ?>" class="btn btn-primary btn-radius" title="<?php echo $this->escape($child->title) ?>">
