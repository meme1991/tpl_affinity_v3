...
?>
<section class="wrapper mod_newsletter <?php echo $params->get('moduleclass_sfx')?>" id="acymailing_module_<?php echo $formName; ?>">
	<div class="container">
		<div class="row">
			...
			<div class="acymailing_fulldiv w-100" id="acymailing_fulldiv_<?php echo $formName; ?>">
				...
				<?php foreach($fieldsToDisplay as $oneField) : ?>
					<?php if($oneField == 'name' AND empty($extraFields[$oneField])) : ?>
							...
							<div class="col-12 col-sm-6 col-md-5 col-lg-5 pr-sm-1">
					...
					<?php if($oneField == 'email' AND empty($extraFields[$oneField])) : ?>
							...
							<div class="col-12 col-sm-6 col-md-5 col-lg-5 mt-2 mt-sm-0 pr-md-1 pl-sm-1">
				...
				<?php endforeach; ?>
						...
						<div class="col-12 col-sm-12 col-md-2 col-lg-2 mt-2 mt-md-0 pl-md-1">
							<input class="button subbutton btn btn-primary btn-block" type="submit"
